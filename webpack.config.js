...
module.exports = {
    ...
    entry: {
        index: path.resolve(__dirname, './js', 'index.js'), // Arquivo que o webpack vai iniciar a ler,
        gerencia: path.resolve(__dirname, './js', 'gerencia.js'), // Arquivo que o webpack vai iniciar a ler,
    },
    ...
    plugins: [
        ...
        new HTMLWebpackPlugin({
            template: './public/gerencia.html',
            filename: 'gerencia.html',
            chunks: ["gerencia"]
        }),
    ]
}